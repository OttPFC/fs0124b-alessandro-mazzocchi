...
me.skills.push('nuovo elemento2')
...
console.log(deleteOne("Parsival", false));
/* ESERCIZIO 5
...
console.log(onlyLetters("I have 4 dogs 8 cats and 12 dolphins"));
/* ESERCIZIO 6
...
function isThisAnEmail(string){
  ...
  if(string.match(regex)){
    ...
    return 'Email non valida! Inserire una Email valida.'
  }
}
console.log(isThisAnEmail("alemaexample.com"));
/* ESERCIZIO 7
...
/* ESERCIZIO 17 (forEach)
  Scrivi una funzione chiamata "searchByTitle" che riceve una stringa come parametro e ritorna i film nell'array "movies" fornito che la contengono nel titolo.
*/
function searchByTitle(movies, title) {
if( movies.find((t) => t.Title == title)){
  return 'Il film è stato trovato : ' + title;
}else{
  return 'Film non stato trovato, controlla eventuali errori di battitura : ' + title;
}
  }
console.log(searchByTitle(movies, 'Amvengers: Endgame'));
/* ESERCIZIO 18
...
console.log(searchAndDivide(movies, 'Avengers: Endgame'));
/* ESERCIZIO 19
...
function removeIndex(index, movies) {
  ...
  if (index >= 0 && index < movies.length) {
    let nuovoArray = [...movies.slice(0, index), ...movies.slice(index + 1)];
    return nuovoArray;
  } else {
    return movies;
  }
...
function isItPrime(n){
  ...
  if (n === undefined) return 'Inserisci un numero!';
